...
local function on_aim_hit(e)
    ...
    local hitgroup_names = { "body", "head", "chest", "stomach", "arm", "arm", "feet", "leg", "neck", "?", "gear" }
        local group = hitgroup_names[e.hitgroup + 1] or "?"

        local target_name = entity.get_player_name(e.target)
        local entityHealth = entity.get_prop(e.target, "m_iHealth")
        print_chat(" \x01[\x01Game\04Sense\x01] " .. "\x01hit\x04 " .. string.lower(target_name) .. "\x01 's \x04" .. group .. "\x01 made \x04" .. e.damage .. "\x01 hurt Hitchance: \x04" .. string.format("%d", e.hit_chance) .. "%")
        ...
        client.color_log(255,255,255," made\0")
        client.color_log(0,255,0,e.damage.."\0")
        client.color_log(255,255,255," hurt Hitchance：\0")
...
local function on_aim_miss(e)
    ...
    elseif e.reason == "death" then
        ...
        print_chat("\x01[\x01Game\04Sense\x01] " .. "\x01miss \x02" .. string.lower(target_name) .. "\x01 's " .. " \x02" .. group .. "\x01 cause： \x02" .. reason.."\x01 Hitchance: \x02" .. string.format("%d", e.hit_chance) .. "%")
        client.color_log(255,255,255,"[\0")
        client.color_log(255,255,255," Game\0")
        client.color_log(100,255,100,"Sense\0")
        client.color_log(255,255,255," ]\0")
        client.color_log(255,255,255," miss \0")
        client.color_log(255,0,0,string.lower(target_name).."\0")
        client.color_log(255,255,255," miss \0")
        client.color_log(255,0,0,group.."\0")
        client.color_log(255,255,255," cause：\0")
